...
## sed -i.bak -e 's/&aacute;/á/' -e 's/&eacute;/é/' -e 's/&iacute;/í/' -e 's/&oacute;/ó/' -e 's/&uacute;/ú/' -e 's/&Aacute;/Á/' -e 's/&Eacute;/É/' -e 's/&Iacute;/Í/' -e 's/&Oacute;/Ó/' -e 's/&Uacute;/Ú/' -e 's/&ntilde;/ñ/' -e 's/&Ntilde;/Ñ/' -e 's/&uuml;/ü/' -e 's/&Uuml;/Ü/' -e 's/&iexcl;/¡/' -e 's/&iquest;/¿/' utf8.*.html
...
dd.html <- gsub(pattern="&Aacute;", replacement="Á", dd.html) # replace accented characters in html
dd.html <- gsub(pattern="&Eacute;", replacement="É", dd.html) # replace accented characters in html
dd.html <- gsub(pattern="&Iacute;", replacement="Í", dd.html) # replace accented characters in html
dd.html <- gsub(pattern="&Oacute;", replacement="Ó", dd.html) # replace accented characters in html
dd.html <- gsub(pattern="&Uacute;", replacement="Ú", dd.html) # replace accented characters in html
dd.html <- gsub(pattern="&aacute;", replacement="á", dd.html) # replace accented characters in html
dd.html <- gsub(pattern="&eacute;", replacement="é", dd.html) # replace accented characters in html
dd.html <- gsub(pattern="&iacute;", replacement="í", dd.html) # replace accented characters in html
dd.html <- gsub(pattern="&oacute;", replacement="ó", dd.html) # replace accented characters in html
dd.html <- gsub(pattern="&uacute;", replacement="ú", dd.html) # replace accented characters in html
dd.html <- gsub(pattern="&Ntilde;", replacement="Ñ", dd.html) # replace accented characters in html
dd.html <- gsub(pattern="&ntilde;", replacement="ñ", dd.html) # replace accented characters in html
dd.html <- gsub(pattern="&Uuml;", replacement="Ü", dd.html) # replace accented characters in html
dd.html <- gsub(pattern="&uuml;", replacement="ü", dd.html) # replace accented characters in html
...
#
obj <- dd2
#pat1 <- grep(obj, pattern="(?i)\\b[áa]bra\\w*\\b\\s*la\\s*votaci[oó]n", perl=TRUE)
pat1 <- grep(obj, pattern="(?i)[áa]bra\\w*\\s+la\\s+votaci[oó]n", perl=TRUE)
#pat2 <- grep(obj, pattern="(?i)\\b[áa]bra\\w*\\b\\s*el\\s*sistema\\s*(?:electr[oó]nico)?\\s(?:de)?\\s*(?:votaci[oó]n)?", perl=TRUE)
pat2 <- grep(obj, pattern="(?i)[áa]bra\\w*\\s+el\\s+sistema\\s+(?:electr[oó]nico\\s+)*(?:de\\s+)*(?:votaci[oó]n)*",
             perl=TRUE)
pat3 <- grep(obj, pattern="(?i)art[íi]culo 1[64][14].*de.*[Rr]eglamento", perl=TRUE)
#pat3 <- grep(obj, pattern="(?i)art[íi]culo 1[64][14]", perl=TRUE)  ## VERSIÓN LAXA
...
pat1 <- grep(obj, pattern="(?i)[áa]bra\\w*\\s+la\\s+votaci[oó]n", perl=TRUE)
#pat2 <- grep(obj, pattern="(?i)\\b[áa]bra\\w*\\b\\s*el\\s*sistema\\s*(?:electr[oó]nico)?\\s(?:de)?\\s*(?:votaci[oó]n)?", perl=TRUE)
pat2 <- grep(obj, pattern="(?i)[áa]bra\\w*\\s+el\\s+sistema\\s+(?:electr[oó]nico\\s+)*(?:de\\s+)*(?:votaci[oó]n)*", perl=TRUE)
pat3 <- grep(obj, pattern="(?i)art[íi]culo 1[64][14].*de.*[Rr]eglamento", perl=TRUE)
#pat3 <- grep(obj, pattern="(?i)art[íi]culo 1[64][14]", perl=TRUE)  ## VERSIÓN LAXA
pat <- sort(c(pat1,pat2,pat3)); n1 <- length(pat)
if (n1<2) {dif <- 1000} else {dif <- c(pat[2:n1],NA)-pat}
...
## obj <- dd2
## pat1 <- grep(obj, pattern="(?i)\\b[áa]bra\\w*\\b\\s*la\\s*votaci[oó]n", perl=TRUE)
## pat2 <- grep(obj, pattern="(?i)\\b[áa]bra\\w*\\b\\s*el\\s*sistema\\s*(?:electr[oó]nico)?\\s(?:de)?\\s*(?:votaci[oó]n)?",
##              perl=TRUE)
## pat3 <- grep(obj, pattern="(?i)art[íi]culo 1[64][14].*de.*reglamento", perl=TRUE)
## #pat3 <- grep(obj, pattern="(?i)art[íi]culo 1[64][14]", perl=TRUE)  ## VERSIÓN LAXA
## pat <- sort(c(pat1,pat2,pat3)); n1 <- length(pat)
## if (n1<2) {dif <- 1000} else {dif <- c(pat[2:n1],NA)-pat}
## dif <- c(1000, dif[-length(dif)]);
...
#    filename <- paste(DipMex, "/matweb/proposiciones/listsHtml/", periodos[n], ".html", sep="")
    ...
    tmp3 <- tmp[tmp2-1]
    fecha <- sub(tmp3, pattern=".*número [0-9]*-.*, (.*)[.].*$", replacement="\\1")
